...
class testBaseApp(unittest.TestCase):
    ...
    def test_method_get_permission_params_with_objects(self):
        ...
        user, perm = MyTest().method(item, permission, resource, "value1",
            context=context, context_value="value2")
...
class testUser(unittest.TestCase):
    ...
    def test_get_with_id(self, mock_client):
        ...
        mock_client.get.assert_called_with(token=token,
            path=AclClient.USERS_UNIQUE, path_params={"user_term":term})
    ...
    def test_create(self, mock_client):
        ...
        mock_client.post.assert_called_with(token=token,
            body={'ingresseId': iid, 'email': email}, path=AclClient.USERS)
    ...
    def test_update_with_object(self, mock_client):
        ...
        mock_client.put.assert_called_with(token=token,
            body={'email': user.email}, path=AclClient.USERS_UNIQUE,
    ...
    def test_remove_with_object(self, mock_client):
        ...
        mock_client.delete.assert_called_with(token=token,
            path=AclClient.USERS_UNIQUE, path_params={"user_term": user.id})
    ...
    def test_add_role_with_objects(self, mock_client):
        ...
        mock_client.post.assert_called_with(token=token,
            body={'role': role.id}, path=AclClient.USERS_ROLES,
            path_params={"user_term": user.id})
    ...
    def test_add_role_with_terms(self, mock_client):
        ...
        mock_client.post.assert_called_with(token=token,
            body={'role': role.name}, path=AclClient.USERS_ROLES,
            path_params={"user_term": user.email})
    ...
    def test_add_permission_with_objects(self, mock_client):
        ...
        response = instance.add_permission(user, permission, resource,
            resource_value, context=context, context_value=context_value)

        mock_client.get.assert_called_with(token=token,
            path=AclClient.USERS_UNIQUE, path_params={"user_term":user.id})

        mock_client.post.assert_called_with(token=token, body=expected_body,
            path=AclClient.USERS_PERMS, path_params={"user_term":user.id})
    ...
    def test_add_permission_with_ids(self, mock_client):
        ...
        response = instance.add_permission(user.id, permission.id, resource.id,
            resource_value, context=context.id, context_value=context_value)
    ...
    def test_add_permission_with_names(self, mock_client):
        ...
        response = instance.add_permission(user.email, permission.name,
            resource.name, resource_value, context=context.name,
        ...
        mock_client.post.assert_called_with(token=token, body=expected_body,
            path=AclClient.USERS_PERMS, path_params={"user_term":user.email})
    ...
    def test_remove_permission_with_objects(self, mock_client):
        ...
        response = instance.remove_permission(user, permission, resource,
            resource_value, context=context, context_value=context_value)

        mock_client.get.assert_called_with(token=token,
            path=AclClient.USERS_UNIQUE, path_params={"user_term":user.id})

        mock_client.delete.assert_called_with(token=token, params=expected_params,
            path=AclClient.USERS_PERMS, path_params={"user_term":user.id})
    ...
    def test_remove_permission_with_ids(self, mock_client):
        ...
        response = instance.remove_permission(user.id, permission.id, resource.id,
            resource_value, context=context.id, context_value=context_value)
    ...
    def test_remove_permission_with_names(self, mock_client):
        ...
        response = instance.remove_permission(user.email, permission.name,
            resource.name, resource_value, context=context.name,
            context_value=context_value)
...
class testRole(unittest.TestCase):
    ...
    def test_get_with_id(self, mock_client):
        ...
        mock_client.get.assert_called_with(token=token,
            path=AclClient.ROLES_UNIQUE, path_params={"role_term":term})
    ...
    def test_update_with_object(self, mock_client):
        ...
        mock_client.put.assert_called_with(token=token,
            ...
            path=AclClient.ROLES_UNIQUE, path_params={"role_term": role.id})
    ...
    def test_update_with_id(self, mock_client):
        ...
        response = instance.update(role.id, alias=role.alias,
    ...
    def test_update_with_name(self, mock_client):
        ...
        response = instance.update(role.name, alias=role.alias,
            description=role.description)

        mock_client.put.assert_called_with(token=token,
            body={'alias':role.alias, 'description':role.description},
            path=AclClient.ROLES_UNIQUE, path_params={"role_term": role.name})
    ...
    def test_add_permission_with_objects(self, mock_client):
        ...
        response = instance.add_permission(role, permission, resource,
            resource_value, context=context, context_value=context_value)
        ...
        mock_client.post.assert_called_with(token=token, body=expected_body,
            path=AclClient.ROLES_PERMS, path_params={"role_term":role.id})
    ...
    def test_add_permission_with_ids(self, mock_client):
        ...
        response = instance.add_permission(role.id, permission.id, resource.id,
            resource_value, context=context.id, context_value=context_value)
    ...
    def test_add_permission_with_names(self, mock_client):
        ...
        response = instance.add_permission(role.name, permission.name,
            resource.name, resource_value, context=context.name,
            context_value=context_value)
        ...
        mock_client.post.assert_called_with(token=token, body=expected_body,
            path=AclClient.ROLES_PERMS, path_params={"role_term":role.name})
    ...
    def test_remove_permission_with_objects(self, mock_client):
        ...
        response = instance.remove_permission(role, permission, resource,
            resource_value, context=context, context_value=context_value)
    ...
    def test_remove_permission_with_ids(self, mock_client):
        ...
        response = instance.remove_permission(role.id, permission.id, resource.id,
            resource_value, context=context.id, context_value=context_value)
    ...
    def test_remove_permission_with_names(self, mock_client):
        ...
        response = instance.remove_permission(role.name, permission.name,
            resource.name, resource_value, context=context.name,
            context_value=context_value)
...
class testBatchUser(unittest.TestCase):
    ...
    def test_execute_with_objects(self, mock_client):
        ...
        instance.add_permission(permission, resource, resource_value,
            context=context, context_value=context_value)
        response = instance.execute()

        mock_client.post.assert_called_with(token=token, body=expected_body,
            path=AclClient.BATCH_USERS_PERM, path_params={"user_term":user.id})
    ...
    def test_execute_with_ids(self, mock_client):
        ...
        instance.add_permission(permission.id, resource.id, resource_value,
            context=context.id, context_value=context_value)
        response = instance.execute()
    ...
    def test_execute_with_terms(self, mock_client):
        ...
        instance.add_permission(permission.name, resource.name, resource_value,
            context=context.name, context_value=context_value)
        response = instance.execute()

        mock_client.post.assert_called_with(token=token, body=expected_body,
            path=AclClient.BATCH_USERS_PERM, path_params={"user_term":user.email})
...
class testBatchRole(unittest.TestCase):
    ...
    def test_execute_permission_with_objects(self, mock_client):
        ...
        mock_client.post.assert_called_with(token=token, body=expected_body,
            path=AclClient.BATCH_ROLES_PERM, path_params={"role_term":role.id})
    ...
    def test_execute_permission_with_names(self, mock_client):
        ...
        mock_client.post.assert_called_with(token=token, body=expected_body,
            path=AclClient.BATCH_ROLES_PERM, path_params={"role_term":role.name})
