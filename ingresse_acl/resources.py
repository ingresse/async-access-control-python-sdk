...
class User(SdkResource):
    def __init__(self, user):
        ...
        self.permissions = [
            UserPermission(item) for item in user.get("permissions", [])
        ]
    ...
    async def get_dict(self):
        ...
        Return: dict
        """
        return {"id": self.id, "ingresseId": self.ingresse_id, "email": self.email}
...
class Role(SdkResource):
    def __init__(self, role):
        ...
        self.permissions = [
            RolePermission(item) for item in role.get("permissions", [])
        ]
